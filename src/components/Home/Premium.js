...
import learn from "../../assets/images/learn.png"; // Updated path
import logo from "../../assets/images/Ambitious logo .jpg"; // Updated path
import "../../assets/css/premium.css"; // Updated path
